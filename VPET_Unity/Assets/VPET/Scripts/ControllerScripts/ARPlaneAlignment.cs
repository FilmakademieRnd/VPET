        ...
        void Update()
        {
			...
			if (Input.touchCount > 0 && m_HitTransform != null)
			{
				...
				if (Input.touchCount > 1) 
				{
					...
					{
						m_initRotation = m_HitTransform.rotation;
                        m_initDistance = Vector2.Distance(touch1.position, touch.position);
					...
					else if (touch1.phase == TouchPhase.Moved)
					{
                        ...
                        if(!mainController.lockARRotation) m_HitTransform.rotation = m_initRotation * Quaternion.Euler (0, angle, 0);
                        if(!mainController.lockARScale) mainController.SetSceneScale(m_initScale * (Vector2.Distance(touch1.position, touch.position)/ m_initDistance));
					}
